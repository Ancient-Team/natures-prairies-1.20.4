...
public class ModFlowers {
    ...
    public static final Block LAWENDER = registerBlock("lawender",
            new FlowerBlock(StatusEffects.REGENERATION, 5, FabricBlockSettings.copyOf(Blocks.ALLIUM).nonOpaque().noCollision()));
    public static final Block POTTED_LAWENDER = Registry.register(Registries.BLOCK, new Identifier(NaturesPrairies.MODID, "potted_lawender"),
            new FlowerPotBlock(LAWENDER, FabricBlockSettings.copyOf(Blocks.POTTED_ALLIUM).nonOpaque()));

    public static final Block PINK_LAWENDER = registerBlock("pink_lawender",
            new FlowerBlock(StatusEffects.REGENERATION, 10, FabricBlockSettings.copyOf(Blocks.ALLIUM).nonOpaque().noCollision()));
    ...
    public static final Block POTTED_PINK_LAWENDER = Registry.register(Registries.BLOCK, new Identifier(NaturesPrairies.MODID, "potted_pink_lawender"),
            new FlowerPotBlock(PINK_LAWENDER, FabricBlockSettings.copyOf(Blocks.POTTED_ALLIUM).nonOpaque()));

    public static final Block BLUE_LAVENDER = registerBlock("blue_lavender",
            new FlowerBlock(StatusEffects.REGENERATION, 15, FabricBlockSettings.copyOf(Blocks.ALLIUM).nonOpaque().noCollision()));
